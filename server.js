...
app.put("/api/users/update/:name", function(req, res) {
    ...
    db.collection(USERS_COLLECTION).findById(req.params.name, function(e,data){  
      ...
      db.collection(USERS_COLLECTION).updateById(req.params.name, update, function(err) { // 5
          if(err) {
